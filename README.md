This repository contains Python scripts designed to extract data from [wildberries.ru](https://www.wildberries.ru/) via its API. You can collect information about specific goods (products) and save it in .xlsx files.
